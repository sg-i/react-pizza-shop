...
function Cart() {
  ...
  const deleteAllPizza = () => {
    dispatch(clearCart);
  };
  const cart = useSelector(({ cart }) => cart);
  let totalCount = cart.totalCount;
  let totalSum = cart.totalSum;
      ...
      <div className={styles.cartWrapper}>
        {items.length !== 0 ? (
          <div className={styles.cartWindow}>
            <div className={styles.cartHeader + ' d-flex justify-between'}>
              ...
              <div
                onClick={deleteAllPizza}
                style={{ height: '30px', margin: 'auto 0' }}
                className={styles.headerRight + ' d-flex align-center'}>
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
            ...
            <div className={styles.allOrder + ' d-flex justify-between'}>
              <span>
                Всего пицц:
                <b>{`  ${totalCount} шт.`}</b>
              </span>
            ...
            <div className={styles.footerCart + ' d-flex justify-between'}>
              <Link to="/">
